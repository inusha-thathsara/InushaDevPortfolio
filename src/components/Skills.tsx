...
const skillCategories: SkillCategory[] = [
  {
    ...
    skills: [
      { name: "JavaScript", level: 90, icon: <FileCode className="w-5 h-5" /> },
  ...
  },
  {
    ...
    skills: [
      { name: "React.js", level: 90, icon: <Atom className="w-5 h-5" /> },
      { name: "Node.js", level: 75, icon: <Server className="w-5 h-5" /> },
      { name: "Tailwind CSS", level: 85, icon: <Paintbrush className="w-5 h-5" /> },
      { name: "Bootstrap", level: 80, icon: <PanelLeft className="w-5 h-5" /> },
      { name: "Flutter", level: 75, icon: <Smartphone className="w-5 h-5" /> },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: "API Integration", level: 85, icon: <Webhook className="w-5 h-5" /> },
  ...
  },
  {
    name: "Other Skills",
    skills: [
      { name: "Web Scraping", level: 75, icon: <Globe className="w-5 h-5" /> },
      { name: "AI/LLM Basics", level: 70, icon: <Brain className="w-5 h-5" /> },
      { name: "Cross-platform Development", level: 80, icon: <Smartphone className="w-5 h-5" /> },
      { name: "Local Storage", level: 85, icon: <Database className="w-5 h-5" /> },
